...
public enum ErrorCode {
    ...
    INVALID_TOKEN(HttpStatus.UNAUTHORIZED, "비정상 토큰 입니다."),
    ACCESS_TOKEN_EXPIRED(HttpStatus.UNAUTHORIZED, "만료된 토큰 입니다."),
    ...
    EXTERNAL_SERVER_TIMEOUT_ERROR(
        HttpStatus.INTERNAL_SERVER_ERROR,
        "외부 서버 연결에 실패했습니다. 관리자 에게 문의 하세요."
    ),
    ;
